...
async def process_syllabus_pipeline(syllabus: UploadFile = File(...)):
    """
    Complete pipeline that processes syllabus → searches PDFs → downloads → creates practice exam
    """
    ...
    try:
        ...
        # STEP 2: Search for past exam PDFs using existing web_search endpoint
        print("\nStep 2: Searching for past exam PDFs...")
        
        # Use the existing web_search function from web_search.py
