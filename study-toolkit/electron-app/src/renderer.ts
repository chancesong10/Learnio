...
if (createPracticeExamBtn) {
    createPracticeExamBtn.addEventListener('click', async () => {
        if (!courseSelect || !courseSelect.value) {
            if (outputDiv) outputDiv.innerText = '⚠️  Please select a course first.';
            return;
        }
        ...
        if (outputDiv) outputDiv.innerText = '⏳ Creating practice exam...';
        ...
        try {
            ...
            if (outputDiv) outputDiv.innerText = errorText;
